...
% These applications are built on a single infrastructure.
% However, even if they were the concepts are not designed to be extensible.
...
% For example, two early decentralized infrastructures that we consider quasi-monolithic are
% diaspora* and Secure ScuttleButt.
