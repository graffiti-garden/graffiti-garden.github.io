...
{\sethlcolor{pink}\hl{subreddits}}, or Facebook groups. %, or Mastodon instances.
...
of context collapse (\emph{e.g.} the ability to limit their posting to suitable {\sethlcolor{pink}\hl{subreddit}}-like scopes)
...
The right to delete one's data was inshrined into law by the European Union's
