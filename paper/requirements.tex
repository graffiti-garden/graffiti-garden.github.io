...
We make the assumption that the system implementing these requirements is \emph{trusted}.
...
\begin{requirement}[Forgving]
    Users should be given the right to be forgotten and the right of deniability.
\end{requirement}
